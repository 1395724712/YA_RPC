    ...
    server_(loop,listenAddr,"YA_RPC server")
{
    ...
    server_.setMessageCallback(bind(&server::onMessageCallback,this,placeholders::_1,
...
void server::onConnectionCallback(const TcpConnectionPtr& conn){
    ...
    if(conn->connected()){
        parseMsg* parseObj = new parseMsg(bind(&server::sum,this,placeholders::_1,placeholders::_2),
        bind(&server::uppercase,this,placeholders::_1));
